...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('openspec-simplify');
      expect(SKILL_NAMES).toContain('openspec-abort-change');
      expect(SKILL_NAMES).toContain('openspec-rewind-change');
      expect(SKILL_NAMES).toContain('openspec-unarchive-change');
    });
  });
