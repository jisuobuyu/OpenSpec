...
The apply workflow orchestrates implementation of OpenSpec changes. It dispatches tasks to isolated subagents, enforces TDD discipline, and tracks progress through checkboxes without creating git commits.
